...
(1) Navigate to notebooks using *http://ROBOT_IP:48888* or open Opentrons Software, click `device`f, `Robot Settings`, `Advanced`, `Launch Jupyter notebook` subsequently<br>
